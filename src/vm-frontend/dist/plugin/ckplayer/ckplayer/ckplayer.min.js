...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			DtolumeJump: 0.1, //音量调整的数量，大于0小于1的小数
			...
			buttonMode: {
				...
				DtolumeSchedule: true //鼠标在音量调节栏上是否显示可点击形态
			},
			liveAndDtod: { //直播+点播=回播功能
			...
			addCallback: 'adPlay,adPause,playOrPause,videoPlay,videoPause,videoMute,videoEscMute,videoClear,changeDtolume,fastBack,fastNext,videoSeek,newVideo,getMetaDate,videoRotation,videoBrightness,videoContrast,videoSaturation,videoHue,videoZoom,videoProportion,videoError,addListener,removeListener,addElement,getElement,deleteElement,animate,animateResume,animatePause,changeConfig,getConfig,openUrl,fullScreen,quitFullScreen,switchFull,screenshot,custom,changeControlBarShow'
			//需要支持的事件
		},
		menu: { //版权名称支持
			ckkey: '',
